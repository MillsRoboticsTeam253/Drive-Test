...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain(){
		...
		leftBack.setSensorPhase(true); /* keep sensor and motor in phase */
		...
		leftBack.config_kP(0, 1, Constants.kTimeoutMs);
		leftBack.config_kI(0, 0, Constants.kTimeoutMs);
		leftBack.config_kD(0, 0, Constants.kTimeoutMs);

		rightBack.config_kF(0, 0, Constants.kTimeoutMs);
		rightBack.config_kP(0, 1, Constants.kTimeoutMs);
		rightBack.config_kI(0, 0, Constants.kTimeoutMs);
		rightBack.config_kD(0, 0, Constants.kTimeoutMs);
