...
public class DriveTrain extends Subsystem {
	...
	private double kPL = 0.5;//0.540
	private double kPR = 0.5;
	private double kIL = -0.0015;//0.00052
	private double kIR = -0.0015;
	private double kDL = 10;//5
	private double kDR = 10;
    ...
    public DriveTrain(){
    	...
    	leftBack.setStatusFramePeriod(StatusFrameEnhanced.Status_10_MotionMagic, 10, Constants.kTimeoutMs); 
		leftBack.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative, 0, 10);
		
		rightBack.setStatusFramePeriod(StatusFrameEnhanced.Status_10_MotionMagic, 10, Constants.kTimeoutMs); 
...
//35074964382
		...
		leftBack.config_kP(0, kPL, Constants.kTimeoutMs);
		leftBack.config_kI(0, kIL, Constants.kTimeoutMs);
		leftBack.config_kD(0, kDL, Constants.kTimeoutMs);

		rightBack.config_kF(0, 0.36910309422, Constants.kTimeoutMs);
		rightBack.config_kP(0, kPR, Constants.kTimeoutMs);
		rightBack.config_kI(0, kIR, Constants.kTimeoutMs);
		rightBack.config_kD(0, kDR, Constants.kTimeoutMs);
